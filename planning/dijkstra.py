...
class Dijkstra:
    def __init__(self, aabb, planning_map, resolution, robot_radius):
        """
        ...
        self.min_x = 0
        self.min_y = 0
        self.max_x = aabb[3] - aabb[0]
        self.max_y = aabb[4] - aabb[1]

        self.x_width = planning_map.shape[0]
        self.y_width = planning_map.shape[1]

        # obstacle map generation
        self.obstacle_map = planning_map
    ...
    def verify_node(self, node):
        ...
        if node.x >= self.obstacle_map.shape[0]:
            return False
        if node.y >= self.obstacle_map.shape[1]:
            return False
